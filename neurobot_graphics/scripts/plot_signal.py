...
class PlotSignalNode(Node):
    def __init__(self):
        super().__init__('plot_signal_node')
        ...
        self.line, = self.ax.plot(self.time_data, self.signal_data, label='Signal generated')
...
def main(args=None):
    ...
    plot_signal_node = PlotSignalNode()

    try:
        rclpy.spin(plot_signal_node)
    except KeyboardInterrupt:
        pass
    finally:
        plot_signal_node.destroy_node()
        rclpy.shutdown()
